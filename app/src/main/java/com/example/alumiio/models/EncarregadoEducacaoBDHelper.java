...
public class EncarregadoEducacaoBDHelper extends SQLiteOpenHelper {


        private static final String DB_NAME = "AlumioDB";
        private static final String TABLE_NAME = "encarregadoEducacao";
        ...
        public EncarregadoEducacaoBDHelper(Context context)
        {
